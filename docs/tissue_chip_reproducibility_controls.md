...
| Contamination | Closed/semi-closed fluid path, sterile disposable tubing, bought sterile connectors/filters, no routine pipetting, closed shuttle transfer | Media-only sterility hold, contamination observation, connector handling qualification, shuttle/airlock transfer qualification | SOP and connector selection; facility approval |
