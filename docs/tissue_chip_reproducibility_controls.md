...
| Flow instability | Syringe pump, media reservoir, sterile tubing harness, cassette row rails, seeding distribution manifold, inline media QC, closed pump/valve calibration station, pressure/flow sensors | Per-row flow calibration, pressure map, pump command-vs-output map, valve actuation map, gravimetric collection check, long-run drift test | Inline sensor service module with pressure/flow ports |
...
| Contamination | Closed/semi-closed fluid path, sterile disposable tubing, bought sterile connectors/filters, aseptic tubing weld/seal prep, closed fluid-path kitting, sterile tote docking, material pass-through/de-bagging, environmental monitoring plate/coupon station, consumable pre-use inspection, cleaning/sanitization validation cart, module CIP/SIP service station, spill-response/decon kit staging, no routine pipetting, closed shuttle transfer, pre-run integrity tester | Media-only sterility hold, contamination observation, connector handling qualification, tubing weld/seal qualification, kit release and leak-test evidence, tote docking qualification, material pass-through qualification, environmental plate/coupon custody, pre-use pouch/seal/integrity evidence, cleaning-cycle evidence, module CIP/SIP coupon/sensor evidence, spill-response drill evidence, shuttle/airlock transfer qualification, pressure-decay pass | SOP and connector selection; facility approval |
...
| Media/reagent lot drift | Physical quarantine/released segregation, closed reagent thaw/equilibration station, bioreactor feed/harvest bag hotel, run-record material scan station, lot scan, temperature-zone placeholders, QC sampling drawer, chilled/room-temperature bag segregation, cold-chain metadata, and release status | Incoming/released lot reconciliation, thaw/equilibration temperature trace, feed/harvest bag identity and load-cell checks, storage excursion check, COA/sterility record review, opened-use timer, and lot-to-run traceability | Media/reagent quarantine pod, thaw/equilibration station, bag-hotel release records, material scan station, and inventory release records |
...
| Insufficient drift measurement | Multimodal monitoring design: flow/pressure, temp/CO2/RH, TEER/impedance, pH/O2, metabolites, closed sample fraction archive, imaging triage, inline sensor cartridge hydration/calibration, calibration-standard custody gate, and run-record material scans | Sensor cartridge release, standard custody/expiry check, missing-data fail, sample custody/data traceability, material identity reconciliation, image/sensor disagreement review | Sensor backplane, inline service module, media sampling/archive interface, imaging station, eBR material model |
