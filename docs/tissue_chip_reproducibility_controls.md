...
| Deviation handling drift | Cassette deviation quarantine station and closed environmental excursion response station with sealed suspect tote dock, isolation cover, environmental logger evidence pocket, deviation barcode/status lands, sample archive handoff, and released/hold/reject lanes | Suspect cassette isolation, excursion evidence capture, sample/fraction custody, environmental logger retrieval, physical status segregation, and deviation-to-run-record reconciliation | Deviation workflow rules and disposition authority |
