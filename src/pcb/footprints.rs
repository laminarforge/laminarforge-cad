use super::nets::*;
use super::{next_uuid, Component, Pad};
use std::fmt::Write;
...
pub fn esp32_pads() -> Vec<Pad> {
    ...
    pads.push(Pad {
        ...
        height: 0.9,
        layers: "\"F.Cu\" \"F.Paste\" \"F.Mask\"",
        net_id: NET_ESP_GPIO_ACT,
        net_name: "ESP_GPIO_ACT",
        drill: None,
    });
    pads
}
...
pub fn sot23_pads_mosfet() -> Vec<Pad> {
    ...
    vec![
        Pad {
            ...
            height: 0.8,
            layers: "\"F.Cu\" \"F.Paste\" \"F.Mask\"",
            net_id: NET_MOSFET_GATE,
            net_name: "MOSFET_GATE",
            drill: None,
        },
        Pad {
            number: "2",
...
pub fn sot23_pads_npn(slot: usize) -> Vec<Pad> {
    ...
    vec![
        Pad {
            ...
            height: 0.8,
            layers: "\"F.Cu\" \"F.Paste\" \"F.Mask\"",
            net_id: NET_LED_BASE_0 + slot as u32,
            net_name: base_net_name,
            drill: None,
        },
        Pad {
            number: "2",
        ...
        Pad {
            ...
            height: 0.8,
            layers: "\"F.Cu\" \"F.Paste\" \"F.Mask\"",
            net_id: NET_LED_CATH_0 + slot as u32,
            net_name: cath_net_name,
            drill: None,
        },
    ]
}
...
pub fn led_0805_pads(slot: usize) -> Vec<Pad> {
    ...
    vec![
        Pad {
            ...
            height: 1.2,
            layers: "\"F.Cu\" \"F.Paste\" \"F.Mask\"",
            net_id: NET_LED_COL_0 + slot as u32,
            net_name: col_net_name,
            drill: None,
        },
        Pad {
            number: "2",
...
pub fn photodiode_pads(slot: usize) -> Vec<Pad> {
    ...
    vec![
        Pad {
            ...
            height: 1.0,
            layers: "\"F.Cu\" \"F.Paste\" \"F.Mask\"",
            net_id: NET_MUX_Y0 + slot as u32,
            net_name: mux_net_name,
            drill: None,
        },
        Pad {
            number: "2",
