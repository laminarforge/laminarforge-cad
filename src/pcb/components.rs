...
pub fn define_components() -> Vec<Component> {
    ...
    comps.push(Component {
        ...
        x: 51.0,
        y: 10.0,
        rotation: 0.0, // moved from x=48 for clearance
        layer: "F.Cu",
    ...
    comps.push(Component {
        ...
        rotation: 0.0,
        layer: "F.Cu",
        description: "ADS1115 decoupling",
        pads: c0603_pads(NET_3V3, "+3V3", NET_GND, "GND"),
    });
    comps.push(Component {
        reference: "C3",
        ...
        rotation: 0.0,
        layer: "F.Cu",
        description: "CD74HC4051 decoupling",
        pads: c0603_pads(NET_3V3, "+3V3", NET_GND, "GND"),
    });
    comps.push(Component {
        reference: "C4",
    ...
    comps.push(Component {
        ...
        rotation: 0.0,
        layer: "F.Cu",
        description: "MOSFET gate decoupling",
        pads: c0603_pads(NET_5V, "+5V", NET_GND, "GND"),
    });
    ...
    comps.push(Component {
        ...
        pads: vec![
            Pad {
                ...
                net_id: NET_LED_PWR_ANODE,
                net_name: "LED_PWR_ANODE",
                drill: None,
            },
            Pad {
                number: "2",
    ...
    comps.push(Component {
        ...
        pads: vec![
            Pad {
                ...
                height: 1.2,
                layers: "\"F.Cu\" \"F.Paste\" \"F.Mask\"",
                net_id: NET_LED_ACT_ANODE,
                net_name: "LED_ACT_ANODE",
                drill: None,
            },
            Pad {
                number: "2",
    ...
    comps.push(Component {
        ...
        value: "22uF",
        footprint_lib: "laminarforge",
        footprint_name: "C_1206",
        lcsc: "C5672",
        x: 72.0,
        y: 5.0,
        rotation: 0.0,
        layer: "F.Cu",
        description: "5V bulk cap (USB power)",
    ...
    comps.push(Component {
        ...
        rotation: 0.0,
        layer: "F.Cu",
        description: "3.3V LDO input cap",
        pads: c1206_pads(NET_5V, "+5V", NET_GND, "GND"),
    });
    ...
    comps.push(Component {
        ...
        rotation: 0.0,
        layer: "F.Cu",
        description: "3.3V LDO output cap",
    ...
    comps.push(Component {
        ...
        rotation: 0.0,
        layer: "F.Cu",
        description: "12V input bulk cap",
    ...
    comps.push(Component {
        ...
        rotation: 0.0,
        layer: "F.Cu",
        description: "ESP32 EN RC delay cap",
    ...
    comps.push(Component {
        ...
        rotation: 0.0,
        layer: "F.Cu",
        description: "VBUS decoupling cap (USB spec)",
