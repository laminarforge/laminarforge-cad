...
pub fn write_silkscreen(pcb: &mut String) {
    writeln!(pcb, r#"  (gr_text "LaminarForge LAMP v1" (at 50 78) (layer "F.SilkS")
    (effects (font (size 1.5 1.5) (thickness 0.2)) (justify left))
  )"#).unwrap();

    writeln!(pcb, r#"  (gr_text "CERN-OHL-S v2" (at 50 76) (layer "F.SilkS")
    ...
    for i in 0..NUM_SLOTS {
        ...
        writeln!(pcb, r#"  (gr_text "{}" (at {} {}) (layer "F.SilkS")
