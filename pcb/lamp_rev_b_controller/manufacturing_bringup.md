...
- Manual/THT notes: hand-place `P7805-2000-S` and `LDD-700H` unless the assembler explicitly confirms through-hole module assembly. Keep `LDD-1000H` and any `P7812-500R` 24 V VDRV option DNP for first articles.
...
4. External supply current-limited bring-up: confirm `VIN_PROTECTED`, P7805 `+5V`, AP63203 `+3V3`, and `+3V3_ANA` before fitting loads.
